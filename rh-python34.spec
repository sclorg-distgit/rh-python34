...
%changelog
* Tue Mar 10 2015 Matej Stuchlik <mstuchli@redhat.com> - 2.0-5
- Rebuild for rhbz#1200058
- Change filelist location (rhbz#1198039)

* Fri Jan 16 2015 Robert Kuska <rkuska@redhat.com> - 2.0-4
- Fix macros name shipped with build subpackage
- Define new macro scl_no_vendor for build subpackage

* Tue Jan 13 2015 Matej Stuchlik <mstuchli@redhat.com> - 2.0-3
- Add manpage to files

* Tue Jan 13 2015 Matej Stuchlik <mstuchli@redhat.com> - 2.0-2
- Define nsfmountable before scl_package, to make it work properly

* Thu Dec 04 2014 Robert Kuska <rkuska@redhat.com> - 2.0-1
- Initial package.
